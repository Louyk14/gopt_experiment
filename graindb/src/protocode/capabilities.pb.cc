...
#include "duckdb/protocode/capabilities.pb.h"
...
struct Capabilities_SimpleExtensionDefaultTypeInternal {
  PROTOBUF_CONSTEXPR Capabilities_SimpleExtensionDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 Capabilities_SimpleExtensionDefaultTypeInternal _Capabilities_SimpleExtension_default_instance_;
...
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_substrait_2fcapabilities_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_substrait_2fcapabilities_2eproto = nullptr;
...
static const ::_pbi::MigrationSchema capa_schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::substrait::Capabilities_SimpleExtension)},
  { 10, -1, -1, sizeof(::substrait::Capabilities)},
};

static const ::_pb::Message* const capa_file_default_instances[] = {
...
const char descriptor_table_protodef_substrait_2fcapabilities_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static ::_pbi::once_flag descriptor_table_substrait_2fcapabilities_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_substrait_2fcapabilities_2eproto = {
    false, false, 392, descriptor_table_protodef_substrait_2fcapabilities_2eproto,
    "substrait/capabilities.proto",
    &descriptor_table_substrait_2fcapabilities_2eproto_once, nullptr, 0, 2,
    capa_schemas, capa_file_default_instances, TableStruct_substrait_2fcapabilities_2eproto::offsets,
    file_level_metadata_substrait_2fcapabilities_2eproto, file_level_enum_descriptors_substrait_2fcapabilities_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_substrait_2fcapabilities_2eproto(&descriptor_table_substrait_2fcapabilities_2eproto);
namespace substrait {
...
inline void Capabilities_SimpleExtension::SharedDtor() {
  ...
  _impl_.function_keys_.~RepeatedPtrField();
  _impl_.type_keys_.~RepeatedPtrField();
  _impl_.type_variation_keys_.~RepeatedPtrField();
  _impl_.uri_.Destroy();
}
...
// @@protoc_insertion_point(message_byte_size_start:substrait.Capabilities.SimpleExtension)
  ...
  // repeated string function_keys = 2;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.function_keys_.size());
  for (int i = 0, n = _impl_.function_keys_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      _impl_.function_keys_.Get(i));
  }

  // repeated string type_keys = 3;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.type_keys_.size());
  for (int i = 0, n = _impl_.type_keys_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      _impl_.type_keys_.Get(i));
  }

  // repeated string type_variation_keys = 4;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.type_variation_keys_.size());
  for (int i = 0, n = _impl_.type_variation_keys_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      _impl_.type_variation_keys_.Get(i));
  }
...
void Capabilities_SimpleExtension::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.function_keys_.MergeFrom(from._impl_.function_keys_);
  _this->_impl_.type_keys_.MergeFrom(from._impl_.type_keys_);
  _this->_impl_.type_variation_keys_.MergeFrom(from._impl_.type_variation_keys_);
  if (!from._internal_uri().empty()) {
...
inline void Capabilities::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.substrait_versions_.~RepeatedPtrField();
  _impl_.advanced_extension_type_urls_.~RepeatedPtrField();
...
// @@protoc_insertion_point(message_byte_size_start:substrait.Capabilities)
  ...
  // repeated string substrait_versions = 1;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.substrait_versions_.size());
  for (int i = 0, n = _impl_.substrait_versions_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      _impl_.substrait_versions_.Get(i));
  }

  // repeated string advanced_extension_type_urls = 2;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.advanced_extension_type_urls_.size());
  for (int i = 0, n = _impl_.advanced_extension_type_urls_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      _impl_.advanced_extension_type_urls_.Get(i));
  }

  // repeated .substrait.Capabilities.SimpleExtension simple_extensions = 3;
  total_size += 1UL * this->_internal_simple_extensions_size();
  for (const auto& msg : this->_impl_.simple_extensions_) {
    total_size +=
...
void Capabilities::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.substrait_versions_.MergeFrom(from._impl_.substrait_versions_);
  _this->_impl_.advanced_extension_type_urls_.MergeFrom(from._impl_.advanced_extension_type_urls_);
  _this->_impl_.simple_extensions_.MergeFrom(from._impl_.simple_extensions_);
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
