...
Connection::Connection(DuckDB &database, int sql_mode_input, string pb_file_input)
    : db(database), context(make_unique<ClientContext>(database, sql_mode_input, pb_file_input)) {
